...
class InternVLChatConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.use_dmole = use_dmole
        self.dmole_arch_path = dmole_arch_path
    ...
    def to_dict(self):
        ...
        output["use_dmole"] = self.use_dmole
        output["dmole_arch_path"] = self.dmole_arch_path
        output["autoencoder_path"] = self.autoencoder_path
